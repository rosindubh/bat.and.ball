...
#This makes the normal mouse pointer invisible in the graphics window
...
#create a timer to contol how often the screen updates
...
#moves bat in accordance with the mouse pointer
